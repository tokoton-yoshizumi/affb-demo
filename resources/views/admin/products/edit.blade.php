                    ...
                    <form method="POST" action="{{ route('products.update', $product->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center space-x-4">
                                <label>
                                    <input type="radio" name="payment_option" value="none" {{ $product->price_id ||
                                    $product->robot_price_id ? '' : 'checked' }}
                                    onclick="togglePaymentOption()">
                                    決済なし
                                </label>
                                <label>
                                    <input type="radio" name="payment_option" value="with_payment" {{ $product->price_id
                                    || $product->robot_price_id ? 'checked' : '' }}
                                    onclick="togglePaymentOption()">
                                    決済あり
                                </label>
                        ...
                        <div id="payment-options"
                            ...
                            <div class="flex items-center space-x-4">
                                <label>
                                    <input type="radio" name="payment_platform" value="stripe" {{ $product->price_id ?
                                    'checked' : '' }} onclick="togglePlatform()">
                                    Stripe
                                </label>
                                <label>
