        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <p class="mt-4">現在の合計報酬: ¥{{ number_format($totalCommission) }}（申請可能な報酬）</p>
                    <p>報酬申請後、口座情報に問題がなければ翌月末日にお振り込みいたします。</p>
                        ...
                        <form action="{{ route('reward.confirm') }}" method="POST" class="mt-6">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="account_type" id="account_type"
                                    ...
                                    required>
                                    <option value="普通預金"
                                        {{ old('account_type', $bankDetails['account_type'] ?? '') == '普通預金' ? 'selected' : '' }}>
                                        普通預金</option>
                                    <option value="当座預金"
                                        {{ old('account_type', $bankDetails['account_type'] ?? '') == '当座預金' ? 'selected' : '' }}>
                                        当座預金</option>
                                </select>
                            </div>
                    ...
                    @else
                        <p class="mt-4 text-red-500">現在、申請可能な報酬はありません。</p>
                    @endif
                                ...
                                @foreach ($commissions as $commission)
                                    <tr class="border-b">
                                        ...
                                        <td class="px-6 py-4 text-md">
                                            ...
                                            @else
                                                <span class="text-gray-500 font-semibold">確定</span>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
